...
import CarPolOvr from "../CarouselChartsCollege/CarPolOvr";
import axios from "axios";

export default class CarouselItemCollege extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      loaded: false,
  ...
  renderLogo() {
    if (JSON.stringify(this.state.team) != "{}") {
      return (
        <a href={`/college-team/${this.state.team.id}`}>
