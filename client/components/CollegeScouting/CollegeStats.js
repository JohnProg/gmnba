...
import CStatsPlayerEntry from "./CStatsPlayerEntry";
import CRatingsPlayerEntry from "./CRatingsPlayerEntry";

export default class CollegeStats extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      renderStats: true,
  ...
  renderPlayers() {
    ...
    if (this.props.players && this.state.renderStats === true) {
      ...
      return sorted.map((player, i) => (
        <CStatsPlayerEntry player={player} key={i} />
      ));
      ...
      return sorted.map((player, i) => (
        <CRatingsPlayerEntry player={player} key={i} />
      ));
    }
  }
