...
export default class GTeamRankGauges extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      team: {},
    ...
    var chartSpeed = Highcharts.chart(
      ...
      Highcharts.merge(gaugeOptions, {
        ...
        series: [
          {
            name: "PTS",
            data: [26 - this.state.gauge1Rank.rank],
            dataLabels: {
              format:
    ...
    var chartTwo = Highcharts.chart(
      ...
      Highcharts.merge(gaugeOptions, {
        ...
        series: [
          {
            name: "PTS",
            data: [26 - this.state.gauge2Rank.rank],
            dataLabels: {
              format:
                '<div style="text-align:center"><span style="font-size:26px;color:' +
                ((Highcharts.theme && Highcharts.theme.contrastTextColor) ||
    ...
    var chartThree = Highcharts.chart(
      ...
      Highcharts.merge(gaugeOptions, {
        ...
        series: [
          {
            name: "PTS",
            data: [26 - this.state.gauge3Rank.rank],
            dataLabels: {
              format:
                '<div style="text-align:center"><span style="font-size:26px;color:' +
                ((Highcharts.theme && Highcharts.theme.contrastTextColor) ||
