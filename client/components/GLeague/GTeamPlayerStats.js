...
import GTeamPlayerRanks from "./GTeamPlayerRanks";

export default class GTeamPlayerStats extends React.Component {
  constructor() {
    super();
    this.state = {
      data: [],
          ...
          point: {
            events: {
              click: event => {
                ...
                window.location =
                  "/gleague-player/" + event.point.series.userOptions.id;
                // this.setState({
