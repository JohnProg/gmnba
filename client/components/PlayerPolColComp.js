...
export default class PlayerPolColComp extends React.Component {
  constructor() {
    super();
  ...
  createChart() {
    var name = "container-column-" + this.props.player.id;
  ...
  render() {
    var chart = "container-column-" + this.props.player.id;
    return (
      <div className="card">
