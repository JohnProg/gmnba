...
export default class PlayerPolColPRBH extends React.Component {
  constructor() {
    super();
  ...
  calculateGrades() {
    ...
    var highPts = 10.0;
    var highEfg = 63.0;
    var highScoreFreq = 53.0;
    var highToFreq = -6.0;
    var highFtFreq = 18.0;
    var highFga = 9.0;

    var freq = this.getGrade(highFreq, this.state.player.freq, 5.5);
    ...
    var fga = this.getGrade(highFga, this.state.player.fga, 0);
    this.setState(
      {
        freq: freq,
        ppp: ppp,
