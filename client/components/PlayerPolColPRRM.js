...
export default class PlayerPolColPRRM extends React.Component {
  constructor() {
    super();
  ...
  calculateGrades() {
    ...
    var efg = this.getGrade(highEfg, this.state.player.efg, 30.0);
    ...
    var fga = this.getGrade(highFga, this.state.player.fga, 0.5);
    this.setState(
      {
        freq: freq,
        ppp: ppp,
  ...
  createChart() {
    var chart = Highcharts.chart("container-column-prbh", {
      chart: {
        polar: true,
        type: "column"
      },
