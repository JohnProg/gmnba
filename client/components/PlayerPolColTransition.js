...
export default class PlayerPolColTransition extends React.Component {
  constructor() {
    super();
  ...
  calculateGrades() {
    ...
    var highPts = 7.0;
    var highEfg = 83.0;
    var highScoreFreq = 75.0;
    var highToFreq = 0;
    var highFtFreq = 40.0;
    var highFga = 4.6;

    var freq = this.getGrade(highFreq, this.state.player.freq, 3.2);
    ...
    var efg = this.getGrade(highEfg, this.state.player.efg, 29.0);
