...
import GStatsPlayerEntry from "./GStatsPlayerEntry";
import GRatingsPlayerEntry from "./GRatingsPlayerEntry";

export default class GLeagueStats extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      renderStats: true,
  ...
  renderPlayers() {
    ...
    if (this.props.players && this.state.renderStats === true) {
      ...
      return sorted.map((player, i) => (
        <GStatsPlayerEntry player={player} key={i} />
      ));
      ...
      return sorted.map((player, i) => (
        <GRatingsPlayerEntry player={player} key={i} />
      ));
    }
  }
