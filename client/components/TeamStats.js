...
export default class TeamStats extends React.Component {
  ...
  calculateGrades() {
    ...
    var fg = this.getGrade(highFg, this.props.team.FG_PCT, 0.43);
    var scoring = this.getGrade(highPoints, this.props.team.PTS, 98);
    var ast = this.getGrade(highAst, this.props.team.AST, 20);
    var reb = this.getGrade(highReb, this.props.team.TRB, 40);
    var stl = this.getGrade(highStl, this.props.team.STL, 6);
    var blk = this.getGrade(highBlk, this.props.team.BLK, 3.5);
    var ft = this.getGrade(highFT, this.props.team.FT_PCT, 0.68);
    var tov = this.getGrade(highTov, this.props.team.TOV * -1, -18);
    var pf = this.getGrade(highPf, this.props.team.PF * -1, -23);
    var threePoint = this.getGrade(
      highThree,
      this.props.team.Three_Pointers_Pct,
      0.32
    );
    var twoPoint = this.getGrade(
      highTwo,
      this.props.team.Two_Pointers_Pct,
      0.47
    );
    var orb = this.getGrade(highOrb, this.props.team.ORB, 8);
    var drb = this.getGrade(highDrb, this.props.team.DRB, 30);
    this.setState({
      fg: fg,
      scoring: scoring,
      ast: ast,
